...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            if 'Unnamed: 0' in df.columns or 'Booking_ID' in df.columns:
            ...
            skew_threshold = self.config["data_processing"]["skewness_threshould"]
    ...
    def select_features(self,df):
        try:
            ...
            num_features_to_select = self.config["data_processing"]["no_of_feature"]
    ...
    def process(self):
        try:
            ...
            self.save_data(train_df, PROCESS_TRAIN_DATA)
            self.save_data(test_df , PROCESS_TEST_DATA)
